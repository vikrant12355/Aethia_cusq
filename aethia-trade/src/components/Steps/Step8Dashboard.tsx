...
import { ShieldCheck, TrendingUp, PieChart, Layers, FileText, CheckCircle2, RefreshCcw, ExternalLink, ArrowUpRight, Search } from "lucide-react";
...
export default function Step8Dashboard({ receipt, approvedStrategy, customWeights }: Step8Props) {
  ...
  const positions: PortfolioPosition[] = [
    { ticker: "NVDA", name: "NVIDIA Corp.", assetClass: "US Equities", allocationPercent: weights.usEquities * 0.35, marketValueUSD: navValue * (weights.usEquities * 0.0035), unrealizedPnLPercent: 18.4, sharpeContribution: 0.82, auditHash: "0x8f3c...1a" },
    { ticker: "MSFT", name: "Microsoft Corp.", assetClass: "US Equities", allocationPercent: weights.usEquities * 0.40, marketValueUSD: navValue * (weights.usEquities * 0.0040), unrealizedPnLPercent: 12.1, sharpeContribution: 0.64, auditHash: "0x7a2b...4c" },
    { ticker: "AAPL", name: "Apple Inc.", assetClass: "US Equities", allocationPercent: weights.usEquities * 0.25, marketValueUSD: navValue * (weights.usEquities * 0.0025), unrealizedPnLPercent: 8.9, sharpeContribution: 0.45, auditHash: "0x9d1e...8f" },
    { ticker: "SHY", name: "iShares 1-3 Year Treasury Bond", assetClass: "US Bonds", allocationPercent: weights.usBonds * 0.60, marketValueUSD: navValue * (weights.usBonds * 0.0060), unrealizedPnLPercent: 2.4, sharpeContribution: 0.38, auditHash: "0x4e8f...9d" },
    { ticker: "TLT", name: "iShares 20+ Year Treasury Bond", assetClass: "US Bonds", allocationPercent: weights.usBonds * 0.40, marketValueUSD: navValue * (weights.usBonds * 0.0040), unrealizedPnLPercent: 1.8, sharpeContribution: 0.22, auditHash: "0x3b2a...1e" },
    { ticker: "GLD", name: "SPDR Gold Shares", assetClass: "Commodities", allocationPercent: weights.commodities, marketValueUSD: navValue * (weights.commodities * 0.01), unrealizedPnLPercent: 14.2, sharpeContribution: 0.51, auditHash: "0x1f2e...9a" },
  ];
  ...
  return (
    <div className="max-w-7xl mx-auto flex flex-col gap-6 py-6 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Growth vs Benchmark Chart (7 cols) */}
